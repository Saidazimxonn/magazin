# Generated by Django 3.1.3 on 2021-01-30 12:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_price', models.DecimalField(decimal_places=2, default=0, max_digits=9, verbose_name='Summa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone', models.CharField(blank=True, max_length=20, null=True, verbose_name='Number phone')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sd_volume_max', models.CharField(blank=True, max_length=255, null=True, verbose_name='The maximum memory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'New order'), ('in_progress', 'Processing order'), ('ready', 'Ready order'), ('completed', 'Completed order')], default='new', max_length=100, verbose_name='Status order')),
                ...
                ('order_date', models.DateField(default=django.utils.timezone.now, verbose_name='Date of receipt of order')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.customer', verbose_name='Client')),
            ],
        ),
        migrations.CreateModel(
            name='Notebook',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_price', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Summa')),
